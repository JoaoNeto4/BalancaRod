...
public class TesteLBPH {
    ...
    public static void main(String[] args) throws FrameGrabber.Exception, InterruptedException {
        ...
        CascadeClassifier detectorFace = new CascadeClassifier("src/br/com/teste/haarcascade-frontalface-alt2.xml");
...
*/       
        ...
        reconhecedor.read("src/br/com/teste/classificadorLBPH.yml");
