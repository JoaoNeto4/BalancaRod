...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelOperador.setFont(new java.awt.Font("Liberation Sans", 0, 14)); // NOI18N
        ...
        jMenu1.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N

        miSair.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        miSair.setText("Sair");
        ...
        jMenu5.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N

        miOperador.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        miParceiro.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        miPesagem.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        miVeiculos.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        miProdutos.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        jMenu4.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        menuBar.add(jMenu4);

        jMenu3.setText("Ferramentas");
        jMenu3.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N

        jmBackup.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        jmConfiguracoes.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        jMenuItem3.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
        ...
        jMenu2.setText("Help");
        jMenu2.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N

        jMenuItem2.setFont(new java.awt.Font("Liberation Sans", 0, 15)); // NOI18N
