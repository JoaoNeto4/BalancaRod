...
public class PesqOrigem extends javax.swing.JDialog {


    private List<OrigemFazenda> listaOrigem = new ArrayList<>();
    
    public PesqOrigem(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private OrigemFazenda retornaObjeto(){
        OrigemFazenda of = new OrigemFazenda();
        of.setOrigem(txtPesquisa.getText());
        return of;
    }
    
    public final void atualizarTabela(){
        try {
            listaOrigem = OrigemFazendaDao.pesquisar(retornaObjeto());
            DefaultTableModel modelo = (DefaultTableModel) tabelaTela.getModel();
            modelo.setNumRows(0);

            for (OrigemFazenda of : listaOrigem) {
                modelo.addRow(new Object[]{
                    of.getId(),
                    of.getParceiro().getFantasia(),
                    of.getOrigem()
                });
            }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtPesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 703, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesqOrigem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesqOrigem dialog = new PesqOrigem(new javax.swing.JFrame(), true);
